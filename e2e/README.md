...
- six blocking Chromium shards for all 420 tests (the active topology remains
  unchanged until a same-commit capacity benchmark proves a better option);
...
the same commit, sequentially and without retries. It reports end-to-end
